...
export const templateConfigSchema = z.object({
  ...
  footer: z.object({
    ...
    show_ledra_badge: z.literal(true).default(true),  // 必須: 常にtrue
...
const FIELD_ACCESS: Record<string, 'all' | 'custom_only' | 'admin_only' | 'readonly'> = {
  ...
  'footer.show_qr': 'all',
  'footer.show_ledra_badge': 'readonly',
...
export function mergeConfigs(
  ...
  if (merged.footer) merged.footer.show_ledra_badge = true;
