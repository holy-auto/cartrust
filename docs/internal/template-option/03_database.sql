...
-- ------------------------------------------------------------
-- Linclaft運営が登録・管理する既製テンプレートのマスタ。
...
COMMENT ON TABLE platform_templates IS '既製テンプレートマスタ。Linclaft運営が登録・管理。加盟店はここから選択してカスタムする。';
...
COMMENT ON COLUMN certificates.template_config_id IS '発行時に使用したテンプレート設定。NULLの場合はLinclaft標準テンプレート。';
