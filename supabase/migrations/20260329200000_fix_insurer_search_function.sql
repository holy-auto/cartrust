-- Fix insurer_search_certificates: drop ALL overloads and recreate cleanly
...
DROP FUNCTION IF EXISTS insurer_search_certificates(text, integer, integer, text, text, text, timestamptz, timestamptz);
