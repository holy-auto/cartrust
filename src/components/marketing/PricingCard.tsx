...
export function PricingCard({
  ...
  return (
    <ScrollReveal variant="fade-up" delay={delay}>
      <div
        className={`rounded-2xl p-8 md:p-10 w-full relative flex flex-col transition-all duration-400 group ${
          recommended
            ? "bg-heading text-white shadow-[0_4px_24px_rgba(17,24,39,0.15)] scale-[1.02] hover:shadow-[0_12px_40px_rgba(17,24,39,0.25)]"
            : "bg-white border border-black/[0.06] shadow-[0_1px_3px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] hover:-translate-y-1"
        }`}
      >
        {recommended && (
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-white text-xs font-medium px-4 py-1.5 rounded-full shadow-[0_2px_8px_rgba(11,92,186,0.4)]">
            おすすめ
          </div>
        )}
