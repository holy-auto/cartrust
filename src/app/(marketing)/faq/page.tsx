...
export const metadata = {
  title: "よくあるご質問",
  description: "Ledraに関するよくあるご質問と回答をまとめました。",
};
  ...
  return (
    <>
      <PageHero
        badge="FAQ"
        title="よくあるご質問"
        subtitle="Ledraに関するご質問をカテゴリ別にまとめました。"
      />
      ...
      <Section>
        ...
        <FAQList>
          <FAQItem
            ...
            answer="Ledraは、自動車の施工記録をデジタル証明書として発行・管理できるクラウドプラットフォームです。施工店と保険会社の双方に、業務効率化と信頼性の向上を提供します。"
          />
          <FAQItem
          ...
          <FAQItem
            ...
            answer="いいえ、LedraはWebブラウザのみで利用できます。特別なソフトウェアのインストールは不要で、インターネット環境があればすぐにご利用開始いただけます。スマートフォンからのアクセスにも対応しています。"
          />
          <FAQItem
      ...
      <Section>
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="Ledraでは、証明書発行後のデータ改ざんを防止する仕組みを実装しています。発行日時、施工内容、施工店情報などすべての情報が固定され、不正な変更ができない設計になっています。"
          />
          <FAQItem
