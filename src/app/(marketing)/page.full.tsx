  ...
  return (
    <>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-1 text-lg font-bold text-white">Linclaft Certificate</div>
                  </div>
      ...
      <Section bg="alt">
        <SectionHeading
          title="ご利用シーン"
          subtitle="さまざまな場面でLinclaftをご活用いただけます"
        />
        <FeatureGrid>
          <FeatureCard
            variant="bordered"
      ...
      <Section>
        ...
        <FAQList>
          ...
          <FAQItem
            ...
            answer="いいえ、LinclaftはWebブラウザのみで利用できます。特別なソフトウェアのインストールは不要で、インターネット環境があればすぐにご利用開始いただけます。"
          />
          <FAQItem
