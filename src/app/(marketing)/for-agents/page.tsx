...
export const metadata = {
  title: "代理店の方へ",
  description: "Ledraパートナープログラムで安定した収益を実現。紹介・コミッション管理を一元化し、効率的な代理店ビジネスを支援します。",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Ledraの代理店として施工店をご紹介いただくことで、継続的なコミッション収入を得られます。"
      />
      ...
      <Section>
        ...
        <FeatureGrid>
          <FeatureCard
            ...
            title="継続的なコミッション報酬"
            description="紹介先の施工店がLedraを利用し続ける限り、毎月のコミッションが発生。ストック型の安定収益を構築できます。"
          />
          <FeatureCard
            delay={100}
            icon={
        ...
        <div className="max-w-3xl mx-auto">
          {[
            ...
            },
            {
              step: "02",
              title: "施工店をご紹介",
              description: "代理店ポータルで発行される紹介リンクや営業資料を活用して、施工店にLedraをご紹介ください。",
            },
            {
              step: "03",
              title: "コミッションを獲得",
