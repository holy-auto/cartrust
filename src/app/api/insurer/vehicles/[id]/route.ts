...
import { apiUnauthorized, apiNotFound, apiValidationError } from "@/lib/api/response";
...
export async function GET(
  ...
  // Get vehicle info (basic, non-PII fields only)
  ...
  // Get certificates for this vehicle via RPC (with audit logging)
